...
MOVW	R0, #lo_addr(?lstr1_Click_IR_Grid2_KINETIS+0)
MOVT	R0, #hi_addr(?lstr1_Click_IR_Grid2_KINETIS+0)
MOVS	R1, #2
...
MOVW	R0, #lo_addr(?lstr2_Click_IR_Grid2_KINETIS+0)
MOVT	R0, #hi_addr(?lstr2_Click_IR_Grid2_KINETIS+0)
MOVS	R1, #2
BL	_mikrobus_logWrite+0
...
MOVW	R0, #lo_addr(?lstr3_Click_IR_Grid2_KINETIS+0)
MOVT	R0, #hi_addr(?lstr3_Click_IR_Grid2_KINETIS+0)
MOVS	R1, #1
BL	_mikrobus_logWrite+0
...
MOVW	R0, #lo_addr(?lstr4_Click_IR_Grid2_KINETIS+0)
MOVT	R0, #hi_addr(?lstr4_Click_IR_Grid2_KINETIS+0)
MOVS	R1, #2
BL	_mikrobus_logWrite+0
;Click_IR_Grid2_KINETIS.c,60 :: 		mikrobus_logWrite("--- Pixel temperature matrix 32x24 ---", _LOG_LINE);
MOVW	R0, #lo_addr(?lstr5_Click_IR_Grid2_KINETIS+0)
MOVT	R0, #hi_addr(?lstr5_Click_IR_Grid2_KINETIS+0)
MOVS	R1, #2
BL	_mikrobus_logWrite+0
...
MOVW	R0, #lo_addr(?lstr6_Click_IR_Grid2_KINETIS+0)
MOVT	R0, #hi_addr(?lstr6_Click_IR_Grid2_KINETIS+0)
MOVS	R1, #1
BL	_mikrobus_logWrite+0
...
MOVW	R0, #lo_addr(?lstr7_Click_IR_Grid2_KINETIS+0)
MOVT	R0, #hi_addr(?lstr7_Click_IR_Grid2_KINETIS+0)
MOVS	R1, #2
BL	_mikrobus_logWrite+0
;Click_IR_Grid2_KINETIS.c,69 :: 		if(((cnt % 32) == 0) && (cnt > 0))
...
MOVW	R0, #lo_addr(?lstr8_Click_IR_Grid2_KINETIS+0)
MOVT	R0, #hi_addr(?lstr8_Click_IR_Grid2_KINETIS+0)
MOVS	R1, #2
BL	_mikrobus_logWrite+0
